        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function setupFormFieldEvents(fieldElement, index) {
                    ...
                    const moveUpBtn = fieldElement.querySelector('.move-up-btn');
                    const moveDownBtn = fieldElement.querySelector('.move-down-btn');
                    ...
                    function updateFormFieldData() {
                        if (formFieldsData[index]) {
                            ...
                            formFieldsData[index].key = keyInput.value;
                    ...
                    keyInput.addEventListener('input', updateFormFieldData);
                    ...
                    moveUpBtn.addEventListener('click', () => moveFormField(index, index - 1));
                    moveDownBtn.addEventListener('click', () => moveFormField(index, index + 1));
                ...
                function fillFormFieldData(fieldElement, data) {
                    ...
                    fieldElement.querySelector('.field-key').value = data.key || '';
